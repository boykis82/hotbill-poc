...
/**
 * TerminationInquiryValidator 테스트
 */
class TerminationInquiryValidatorTest {

    private TerminationInquiryValidator validator;

    @BeforeEach
    void setUp() {
        validator = new TerminationInquiryValidator();
    }
